...
<head>
  ...
  <title>Opencmis DBShare Server</title>
  <style type="text/css">
  <!--
  body {
...
<h1>opencmis-server-rdbms Server</h1>

<p style="font-weight: bold">Your server is up and running.</p>
<p>The opencmis-server-rdbms server is a CMIS server based on Apache Chemistry OpenCMIS.</p>
